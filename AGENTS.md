...
- Canonical repo target: `kotlin-friendly-regex`. Useful entrypoints: `dev project show kotlin-friendly-regex`, `dev build kotlin-friendly-regex`, `dev check kotlin-friendly-regex`.
- Setup-managed files are regenerated with `dev setup kotlin-friendly-regex`; avoid hand-editing stamped generated files.
