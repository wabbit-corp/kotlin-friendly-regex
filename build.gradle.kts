...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-friendly-regex", "1.0.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-friendly-regex")
        description.set("kotlin-friendly-regex")
        url.set("https://github.com/wabbit-corp/kotlin-friendly-regex")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-friendly-regex")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-friendly-regex.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-friendly-regex.git")
        }
    }
}
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.friendlyregex"
        compileSdk = 34
        minSdk = 26
    }
...
dokka {
    moduleName.set("kotlin-friendly-regex")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-friendly-regex/tree/master/src")
