...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-friendly-regex"
            version = "1.0.0"
...
kover {
    ...
    //             // title.set("kotlin-friendly-regex Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-friendly-regex/tree/master/src/main/kotlin")
